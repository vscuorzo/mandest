...
int main(int argc, char *argv[])
{
	...
	if(argc>1)
	{
		...
		while(++i<argc)
		{
			...
			{
				if(SDL_VideoModeOK(1024, 768, 32, SDL_RESIZABLE | SDL_ANYFORMAT | SDL_HWSURFACE))
					videobuffer = SDL_SetVideoMode(1024, 768, 32, SDL_RESIZABLE | SDL_ANYFORMAT | SDL_HWSURFACE);
			}
			else
